...
export default class CodingChallengeWebPart extends BaseClientSideWebPart<ICodingChallengeWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<ICodingChallengeProps> = React.createElement(
      CodingChallenge,
      {
